...
    // this generates a separate chunk (about.[hash].js) for this rota
    // which is lazy-loaded when the rota is visited.
    component: function () {
...
export and save this filé in leocloud

export to Nagoteam
export to Mu
Export tô FBI & Swatch
export default rota_imo
export to Union
export to (Android MacOSGold) & make a New filé(cargapeso.py) in androidmacosgold
